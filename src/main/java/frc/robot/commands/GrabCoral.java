...
public class GrabCoral extends SequentialCommandGroup {
   ...
   // public AutoRaiseCoral(Elevator elevator){
    ...
    public GrabCoral(Shoulder shoulder, Elevator Elevator, Claw Claw){
        // Add Commands here:
        // Also add parallel commands using the
        //
        addCommands(
              new MoveShoulder(shoulder).withTimeout(1),
              new MoveElevator(Elevator).withTimeout(1),
              new CoralClawIntake(Claw).withTimeout(1),
