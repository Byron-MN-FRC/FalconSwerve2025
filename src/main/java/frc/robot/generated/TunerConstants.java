...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(19.48).withKI(0).withKD(0.2457)
        .withKS(0).withKV(0).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(.0533).withKI(0).withKD(0)
        .withKS(0.0831).withKV(0.11).withKA(.0035);
    ...
    private static final Distance kFrontRightXPos = Inches.of(6.125);
    private static final Distance kFrontRightYPos = Inches.of(-6.125);
    ...
    private static final Distance kBackLeftXPos = Inches.of(-6.125);
    private static final Distance kBackLeftYPos = Inches.of(6.125);
    ...
    private static final Distance kBackRightXPos = Inches.of(-6.125);
    private static final Distance kBackRightYPos = Inches.of(-6.125);
